 ...
 * @author user
 */
public class cetak_rjalan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        kd_jalan = new javax.swing.JTextField();
        ...
        jLabel1.setBounds(140, 10, 240, 25);
        ...
        jLabel3.setBounds(140, 40, 240, 25);
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(kd_jalan, javax.swing.GroupLayout.PREFERRED_SIZE, 285, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(kd_jalan, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel2)
        ...
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addComponent(jDesktopPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE)
...
String transaksi = kd_jalan.getText();  // TODO add your handling code here:
         try{
...
String sql="select * from rawat_jalan where "+ "kd_jalan='" +kd_jalan.getText()
+"'";
 ResultSet rs = statement.executeQuery(sql);
            if (rs.next()){
              jTextArea1.setText("                           *** Puskesmas IPI Garut ***"+
                      ...
                      "\n"
                                      + "       Kode Rawat Jalan                        : " + rs.getString(1)+ "\n" 
                                      + "       Kode Dokter                                   : " + rs.getString(2)+ "\n" 
                                      + "       Nama                                              : " + rs.getString(3)+ "\n"
                                      + "       Kode Pasien                                  : " + rs.getString(4)+ "\n"
                                      + "       Nama Pasien                                : " + rs.getString(5) +"\n"
                                      + "       Kode Resep                                  : " + rs.getString(6) +"\n"
                                      + "       Nama Obat                                    : " + rs.getString(7) +"\n"
                                      + "       Tanggal Periksa                           : " + rs.getString(8) +"\n"
                                      +
                       "\n"+         
                                 "\n============================================"+
                                              "\n"+
                                 "\n        Terimasih Telah Berkunjung Ke Puskesmas Garut,"+
    ...
    private void txtcetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtcetakActionPerformed
        // TODO add your handling code here:
         try {
          new cetak_rjalan().printComponents(null);
          jTextArea1.print();
          jTextArea1.setText("");
          kd_jalan.setText("");
...
dispose();        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cetak_rjalan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField kd_jalan;
